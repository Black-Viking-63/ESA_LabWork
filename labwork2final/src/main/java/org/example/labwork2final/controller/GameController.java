...
import org.example.labwork2final.model.*;
import org.example.labwork2final.service.*;
...
public class GameController {
    ...
    public String getUpdatePage(@PathVariable("id") Long gamesId, Model model) {
        Game game = gameService.get(gamesId);
